...
func _0021_add_session_id_to_metricsUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "0021_add_session_id_to_metrics.up.sql", size: 55, mode: os.FileMode(0644), modTime: time.Unix(1618836452, 0)}
...
func _1618237885_settings_anon_metrics_should_sendUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1618237885_settings_anon_metrics_should_send.up.sql", size: 80, mode: os.FileMode(0644), modTime: time.Unix(1618836452, 0)}
...
func _1618395756_contacts_onlyUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1618395756_contacts_only.up.sql", size: 136, mode: os.FileMode(0644), modTime: time.Unix(1618913045, 0)}
...
func _1618412233_add_processed_to_metricsUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1618412233_add_processed_to_metrics.up.sql", size: 54, mode: os.FileMode(0644), modTime: time.Unix(1618913046, 0)}
...
func _1618571271_add_id_to_app_metricsUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1618571271_add_id_to_app_metrics.up.sql", size: 611, mode: os.FileMode(0644), modTime: time.Unix(1618913118, 0)}
